...
| Arctis 7+ / PS5 / Xbox / Destiny | ✅ | 32 | $\color{royalblue}{\textbf{220e}}$, $\color{royalblue}{\textbf{2212}}$, $\color{royalblue}{\textbf{2216}}$, 2236 |
| Arctis 9 Wireless | ✅ | 16 | $\color{royalblue}{\textbf{12c2}}$ |
| Arctis Pro Wireless | ✅ | 38 | $\color{royalblue}{\textbf{1290}}$, $\color{royalblue}{\textbf{1294}}$ |
| Arctis Nova Pro Wireless / X | ✅ | 304 | $\color{royalblue}{\textbf{12e0}}$, $\color{royalblue}{\textbf{12e5}}$, $\color{royalblue}{\textbf{225d}}$ |
| Arctis Nova Pro Wired / Xbox Wired | ✅ | 39 | $\color{royalblue}{\textbf{12cb}}$, $\color{royalblue}{\textbf{12cd}}$ |
| Arctis Nova Pro Omni | ✅ | 37 | $\color{royalblue}{\textbf{2290}}$ |
...
| Arctis Nova 5 / 5X | ✅ | 69 | $\color{royalblue}{\textbf{2232}}$, $\color{royalblue}{\textbf{2253}}$, $\color{royalblue}{\textbf{2255}}$, $\color{royalblue}{\textbf{2264}}$ |
| Arctis Nova 7 Gen 1 | ✅ | 43 | $\color{royalblue}{\textbf{2202}}$, $\color{royalblue}{\textbf{2206}}$, 223a, $\color{royalblue}{\textbf{227a}}$, $\color{royalblue}{\textbf{22a4}}$ |
| Arctis Nova 7 Gen 2 | ✅ | 152 | $\color{royalblue}{\textbf{22a1}}$, $\color{royalblue}{\textbf{227e}}$, $\color{royalblue}{\textbf{2258}}$, $\color{royalblue}{\textbf{229e}}$, $\color{royalblue}{\textbf{22a9}}$, $\color{royalblue}{\textbf{22a5}}$, $\color{royalblue}{\textbf{22ab}}$ |
| Arctis Nova 7P | ✅ | 17 | $\color{royalblue}{\textbf{220a}}$, $\color{royalblue}{\textbf{22a7}}$ |
| Arctis Nova Elite | ✅ | 16 | $\color{royalblue}{\textbf{2244}}$, 2249, $\color{royalblue}{\textbf{2270}}$ |
...
<!-- STATS:META:START -->
_Based on **877** unique users (**64611** anonymous data points) — last updated 2026-09-07_
<!-- STATS:META:END -->
...
| CachyOS | 🎯 AUR | 👥 367 |
| Arch Linux | 🎯 AUR | 👥 168 |
| Nobara Linux 44 (KDE Plasma Desktop Edition) | 🎯 COPR | 👥 48 |
| Fedora Linux 44 (KDE Plasma Desktop Edition) | 🎯 COPR | 👥 47 |
| Linux Mint 22.3 | 🎯 PPA | 👥 46 |
| Ubuntu 26.04 LTS | 🎯 PPA | 👥 25 |
| Pop!_OS 24.04 LTS | 🎯 PPA | 👥 19 |
| EndeavourOS | 🎯 AUR | 👥 19 |
| Fedora Linux 44 (Workstation Edition) | 🎯 COPR | 👥 18 |
| Ubuntu 26.04.1 LTS | 🎯 PPA | 👥 16 |
...
| Headset | Installs |
|---|---|
| Arctis Nova Pro Wireless | 304 |
| Arctis Nova 7 (Gen 2) | 152 |
| Arctis Nova 5 Wireless | 69 |
| Arctis Nova 7 (Gen 1) | 43 |
| Arctis Nova Pro Wired | 39 |
| Arctis Pro Wireless | 38 |
| Arctis Nova Pro Omni | 37 |
| Arctis 7+ | 32 |
| Arctis Nova 3 Wireless | 21 |
| Arctis GameBuds | 20 |
| Arctis 7/Pro Gaming | 17 |
| Arctis Nova 7P (Gen 2) | 17 |
| Arctis Nova 3 | 17 |
| Arctis 9 Wireless | 16 |
| Arctis Nova Elite | 16 |
...
| CachyOS | 367 |
| Arch Linux | 168 |
| Nobara Linux 44 (KDE Plasma Desktop Edition) | 48 |
| Fedora Linux 44 (KDE Plasma Desktop Edition) | 47 |
| Linux Mint 22.3 | 46 |
| Ubuntu 26.04 LTS | 25 |
| Pop!_OS 24.04 LTS | 19 |
| EndeavourOS | 19 |
| Fedora Linux 44 (Workstation Edition) | 18 |
| Ubuntu 26.04.1 LTS | 16 |
...
| [nobodys-tools](https://github.com/nobodys-tools) | Seeded the missing default HRIR for module-only installs (#79); reported the virtual-microphone hijack bug ([#185](https://github.com/loteran/Arctis-Sound-Manager/issues/185)); suggested the surround-deadline notification, per-profile CPU-cost labels and the audio stability setting ([#183](https://github.com/loteran/Arctis-Sound-Manager/issues/183)); reported the expired Discord invite ([#184](https://github.com/loteran/Arctis-Sound-Manager/issues/184)); diagnosed the Home page's endless background refresh ([#182](https://github.com/loteran/Arctis-Sound-Manager/issues/182)) |
| [TheJurassicSnark](https://github.com/TheJurassicSnark) | Reported "Launch at login" breaking after the 1.3.0 tray rename ([#191](https://github.com/loteran/Arctis-Sound-Manager/issues/191)); helped diagnose the SteamOS/Bazzite/Silverblue AUR update failure (#175) |
| [zany130](https://github.com/zany130) | Reported audio not defaulting to the headset when it powers on ([#135](https://github.com/loteran/Arctis-Sound-Manager/issues/135)) |
| [camperotactico](https://github.com/camperotactico) | Reported the on-device equaliser button missing on several headset families, the unlabeled fourth audio channel, the Noise Cancelling section appearing on headsets without one, and a stale device profile blocking newer USB product IDs — including getting the Nova 7P Gen 2 recognised (#146) |
| [craciu25yt](https://github.com/craciu25yt) | Reported (on Discord) that virtual surround could clip on hot HRIRs, and that the fix didn't reach existing installs after upgrading — led to the filter-chain config version-marker mechanism |
| [jsuvanto](https://github.com/jsuvanto) | Helped diagnose the USB-permissions boot-time race on Nobara (discussion [#140](https://github.com/loteran/Arctis-Sound-Manager/discussions/140)) |
| [DefactoCasual](https://github.com/DefactoCasual) | Helped diagnose the USB-permissions boot-time race on Nobara (discussion [#140](https://github.com/loteran/Arctis-Sound-Manager/discussions/140)) |
...
| [Malev0](https://github.com/Malev0) | Requested the headset be selectable as the Output channel's own device ([#139](https://github.com/loteran/Arctis-Sound-Manager/issues/139)) |
| [eapzzz](https://github.com/eapzzz) | Reported the AUR install failures — a `bsdtar` locale error and a `ModuleNotFoundError` on `asm-setup` ([#132](https://github.com/loteran/Arctis-Sound-Manager/issues/132)) |
| [jnunez2301](https://github.com/jnunez2301) | Reported the DAC's custom display not updating live as settings changed ([#172](https://github.com/loteran/Arctis-Sound-Manager/issues/172)) |
| [ninjapinja2](https://github.com/ninjapinja2) | Reported Spatial Audio staying silent inside Distrobox, and staying silent with no HRIR profile chosen (#100) |
| [akio4800](https://github.com/akio4800) | Requested Bluetooth output device selection, and reported channel volume resetting to 100% after a virtual sink recreation (#134) |
