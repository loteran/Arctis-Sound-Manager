...
| Arctis Nova Pro Wireless / X | ✅ | 9 | $\color{royalblue}{\textbf{12e0}}$, 12e5 |
| Arctis Nova Pro Wired / Xbox Wired | ✅ |  | $\color{royalblue}{\textbf{12cb}}$, 12cd |
| Arctis Nova 3 | ✅ | 1 | $\color{royalblue}{\textbf{12ec}}$ |
| Arctis Nova 3P / 3X Wireless | ✅ | 1 | $\color{royalblue}{\textbf{2269}}$, 226d |
...
| Arctis Nova 7 Gen 2 | ✅ | 7 | $\color{royalblue}{\textbf{22a1}}$, $\color{royalblue}{\textbf{227e}}$, 2258, 229e, 22a9, 22a5 |
...
<!-- STATS:META:START -->
_Based on **27** unique users (**170** anonymous data points) — last updated 2026-05-12_
<!-- STATS:META:END -->
...
| Headset | Installs |
|---|---|
| Arctis Nova Pro Wireless | 9 |
| Arctis Nova 7 (Gen 2) | 7 |
| Arctis 9 Wireless | 3 |
