...
<!-- STATS:META:START -->
_Based on **163** unique users (**57234** anonymous data points) — last updated 2026-06-18_
<!-- STATS:META:END -->
...
| Manjaro Linux | 🎯 AUR | 👥 2 |
| Fedora Linux 44 (Workstation Edition) | 🎯 COPR | 👥 2 |
| EndeavourOS | 🎯 AUR | 👥 2 |
...
| NixOS 26.11 (Zokor) | 2 |
| Manjaro Linux | 2 |
| Fedora Linux 44 (Workstation Edition) | 2 |
| EndeavourOS | 2 |
<!-- STATS:DISTROS:END -->
</details>
