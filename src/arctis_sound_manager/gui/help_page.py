        ...
        "sections": [
            ...
            },
            {
                ...
                "body": (
                    ...
                    "fine-tune the spatial effect. The HRIR Profile drop-down lets you "
                    "choose from 57 built-in profiles (Dolby Atmos, CMSS-3D, GSX, DTS:X…).\n\n"
                    "── Volume Boost ──\n"
            ...
            },
            {
                ...
                "body": (
                    ...
                    "── HRIR Profile ──\n"
                    "A drop-down in the Spatial Audio section lets you choose from 57 "
                    "built-in HRIR profiles grouped by brand: Dolby Atmos, CMSS-3D, "
                    "SBX Pro Studio, Sennheiser GSX, DTS Headphone:X, Windows Sonic, "
                    "Razer Surround, Out Of Your Head, Waves NX, Flux HEar, "
        ...
        "sections": [
            ...
            },
            {
                ...
                "body": (
                    ...
                    "Le menu déroulant Profil HRIR permet de choisir parmi 57 profils "
                    "intégrés (Dolby Atmos, CMSS-3D, GSX, DTS:X…). "
            ...
            },
            {
                ...
                "body": (
                    ...
                    "── Profil HRIR ──\n"
                    "Un menu déroulant dans la section Spatial Audio permet de choisir parmi "
                    "57 profils HRIR intégrés, groupés par marque : Dolby Atmos, CMSS-3D, "
                    "SBX Pro Studio, Sennheiser GSX, DTS Headphone:X, Windows Sonic, "
                    "Razer Surround, Out Of Your Head, Waves NX, Flux HEar, "
        ...
        "sections": [
            ...
            },
            {
                ...
                "body": (
                    ...
                    "── Perfil HRIR ──\n"
                    "Un menú desplegable en la sección Spatial Audio permite elegir entre "
                    "57 perfiles HRIR integrados, agrupados por marca: Dolby Atmos, CMSS-3D, "
                    "SBX Pro Studio, Sennheiser GSX, DTS Headphone:X, Windows Sonic, "
                    "Razer Surround, Out Of Your Head, Waves NX, Flux HEar, "
