...
def _running_in_container() -> bool:
    ...
    # be copy-pasted here, in udev_checker.py and in gui/system_deps_dialog.py,
    # and the copies drifted). Imported lazily and defensively: this must
    # never be the thing that stops the daemon unit from being written.
    try:
