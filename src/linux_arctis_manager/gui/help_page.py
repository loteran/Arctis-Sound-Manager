...
from linux_arctis_manager.gui.components import DividerLine
        ...
        "sections": [
            {
                ...
                "body": (
                    ...
                    "The app runs as a background service (lam-daemon) managed by systemd, and a "
                    "GUI front-end (lam-gui) that connects to it over D-Bus."
                ),
            },
            {
                ...
                "body": (
                    ...
                    "2. Launch the app from your application menu or run lam-gui in a terminal.\n"
            ...
            },
            {
                ...
                "body": (
                    "Device not detected:\n"
                    "• Make sure udev rules are installed: run lam-cli udev write-rules --reload\n"
                    "• Reconnect the USB cable.\n"
                    "• Check that lam-daemon is running: systemctl --user status lam-daemon\n\n"
                    "Settings not applied:\n"
                    "• Restart the daemon: systemctl --user restart lam-daemon\n\n"
                    "GUI does not open:\n"
                    "• Run lam-gui -vvvv in a terminal to see detailed logs.\n"
                    "• Check that lam-daemon is running (see above)."
                ),
            },
        ],
    },
        ...
        "sections": [
            {
                ...
                "body": (
                    ...
                    "L'application fonctionne comme un service en arrière-plan (lam-daemon) géré "
                    "par systemd, et une interface graphique (lam-gui) qui s'y connecte via D-Bus."
                ),
            },
            {
                ...
                "body": (
                    ...
                    "2. Lancez l'application depuis le menu ou exécutez lam-gui dans un terminal.\n"
                    ...
                    "relancez lam-gui depuis le lanceur."
                ),
            },
            {
                "heading": "Accueil",
            ...
            },
            {
                ...
                "body": (
                    ...
                    "lam-cli udev write-rules --reload\n"
                    "• Rebranchez le câble USB.\n"
                    "• Vérifiez que lam-daemon fonctionne : "
                    "systemctl --user status lam-daemon\n\n"
                    "Paramètres non appliqués :\n"
                    "• Redémarrez le daemon : systemctl --user restart lam-daemon\n\n"
                    "Interface qui ne s'ouvre pas :\n"
                    "• Lancez lam-gui -vvvv dans un terminal pour voir les logs détaillés.\n"
                    "• Vérifiez que lam-daemon fonctionne (voir ci-dessus)."
                ),
            },
        ],
    },
        ...
        "sections": [
            {
                ...
                "body": (
                    ...
                    "sistema.\n\n"
                    "La aplicación se ejecuta como un servicio en segundo plano (lam-daemon) "
                    "administrado por systemd, y una interfaz gráfica (lam-gui) que se conecta "
            ...
            },
            {
                ...
                "body": (
                    ...
                    "2. Lanza la aplicación desde el menú o ejecuta lam-gui en una terminal.\n"
                    ...
                    "o vuelve a ejecutar lam-gui desde el lanzador."
                ),
            },
            {
                "heading": "Inicio",
            ...
            },
            {
                ...
                "body": (
                    ...
                    "• Comprueba que lam-daemon esté activo: "
                    "systemctl --user status lam-daemon\n\n"
                    "Ajustes no aplicados:\n"
                    "• Reinicia el daemon: systemctl --user restart lam-daemon\n\n"
                    "La interfaz no se abre:\n"
                    "• Ejecuta lam-gui -vvvv en una terminal para ver los registros detallados.\n"
                    "• Comprueba que lam-daemon esté activo (ver arriba)."
                ),
            },
        ],
    },
